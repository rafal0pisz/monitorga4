...
const shopChecks: CheckResult[] = [
  { id: 'self_referral', section: 'traffic', label: 'Self-referral', description: 'Sessions from your own domain appearing as referral traffic instead of direct/organic.', status: 'pass', valueLabel: '0.4%', prevLabel: '0.6%', deltaLabel: '−0.2pp' },
  { id: 'direct_traffic_spike', section: 'traffic', label: 'Direct traffic spike', description: 'Week-over-week change in the share of sessions with medium "(none)".', status: 'pass', valueLabel: '18.2%', prevLabel: '17.5%', deltaLabel: '+4.0%' },
  { id: 'new_hostname', section: 'traffic', label: 'New hostname', description: 'Flags any hostname with 100+ sessions that wasn’t seen in the previous 7 days.', status: 'pass', valueLabel: 'No change', prevLabel: '', deltaLabel: 'All clear' },
  { id: 'engagement_rate', section: 'engagement', label: 'Engagement Rate', description: 'Share of sessions lasting 10s+, with a conversion event, or 2+ pageviews. Note: above 75% can be artificially inflated — check your Engagement Rate / engaged-session settings in GA4.', status: 'pass', valueLabel: '78.4%', prevLabel: '76.0%', deltaLabel: '+3.2%' },
  { id: 'bounce_rate', section: 'engagement', label: 'Bounce rate anomaly', description: 'Week-over-week change in bounce rate.', status: 'pass', valueLabel: '31.2%', prevLabel: '33.0%', deltaLabel: '−5.5%' },
  { id: 'conversion_rate', section: 'engagement', label: 'Conversion rate', description: 'Week-over-week change in session conversion rate.', status: 'warn', valueLabel: '1.8%', prevLabel: '2.6%', deltaLabel: '−30.8%' },
  { id: 'geo_anomaly', section: 'users', label: 'Geographic anomaly', description: 'New countries pulling more than 3% of total sessions.', status: 'pass', valueLabel: 'No change', prevLabel: '', deltaLabel: 'All clear' },
  { id: 'bot_traffic_night', section: 'users', label: 'Bot traffic (night hours)', description: 'Share of sessions during 2–5am local time, a common bot signature.', status: 'pass', valueLabel: '2.1%', prevLabel: '2.4%', deltaLabel: '−0.3pp' },
  { id: 'unknown_country', section: 'users', label: 'Unknown country share', description: 'Week-over-week change in the share of sessions with no resolvable country.', status: 'pass', valueLabel: '0.8%', prevLabel: '1.1%', deltaLabel: '−0.3pp' },
]
...
const shopHistory: DemoHistoryEntry[] = [
  ...
  { date: isoDate(new Date(DEMO_TODAY.getTime() - 15 * 86400000)), label: 'Bounce rate anomaly', kind: 'warn', detail: 'Bounce rate: 44.1% (prev: 33.5%, WoW: +31.6%)', category: 'engagement' },
...
const blogChecks: CheckResult[] = [
  { id: 'self_referral', section: 'traffic', label: 'Self-referral', description: 'Sessions from your own domain appearing as referral traffic instead of direct/organic.', status: 'pass', valueLabel: '0.2%', prevLabel: '0.3%', deltaLabel: '−0.1pp' },
  { id: 'direct_traffic_spike', section: 'traffic', label: 'Direct traffic spike', description: 'Week-over-week change in the share of sessions with medium "(none)".', status: 'warn', valueLabel: '29.1%', prevLabel: '23.8%', deltaLabel: '+22.4%' },
  { id: 'new_hostname', section: 'traffic', label: 'New hostname', description: 'Flags any hostname with 100+ sessions that wasn’t seen in the previous 7 days.', status: 'warn', valueLabel: '1 new', prevLabel: '', deltaLabel: 'stats-preview.blogtechniczny.pl', detail: 'New: stats-preview.blogtechniczny.pl' },
  { id: 'engagement_rate', section: 'engagement', label: 'Engagement Rate', description: 'Share of sessions lasting 10s+, with a conversion event, or 2+ pageviews.', status: 'warn', valueLabel: '38.4%', prevLabel: '44.0%', deltaLabel: '−12.7%' },
  { id: 'bounce_rate', section: 'engagement', label: 'Bounce rate anomaly', description: 'Week-over-week change in bounce rate.', status: 'warn', valueLabel: '52.6%', prevLabel: '41.0%', deltaLabel: '+28.3%' },
  { id: 'conversion_rate', section: 'engagement', label: 'Conversion rate', description: 'Week-over-week change in session conversion rate.', status: 'pass', valueLabel: '3.1%', prevLabel: '2.9%', deltaLabel: '+6.9%' },
  { id: 'geo_anomaly', section: 'users', label: 'Geographic anomaly', description: 'New countries pulling more than 3% of total sessions.', status: 'warn', valueLabel: '1 new', prevLabel: '', deltaLabel: 'Vietnam', detail: 'New: Vietnam' },
  { id: 'bot_traffic_night', section: 'users', label: 'Bot traffic (night hours)', description: 'Share of sessions during 2–5am local time, a common bot signature.', status: 'pass', valueLabel: '1.5%', prevLabel: '1.6%', deltaLabel: '−0.1pp' },
  { id: 'unknown_country', section: 'users', label: 'Unknown country share', description: 'Week-over-week change in the share of sessions with no resolvable country.', status: 'pass', valueLabel: '0.5%', prevLabel: '0.6%', deltaLabel: '−0.1pp' },
]
...
const blogHistory: DemoHistoryEntry[] = [
  ...
  { date: isoDate(new Date(DEMO_TODAY.getTime() - 3 * 86400000)), label: 'Bounce rate anomaly', kind: 'warn', detail: 'Bounce rate: 52.6% (prev: 41.0%, WoW: +28.3%)', category: 'engagement' },
...
export const DEMO_PROJECTS: DemoProjectSummary[] = [
  {
    ...
    ecommerce_events_count: 4, custom_events_count: 1, parameter_checks_count: 5,
  },
  {
    id: BLOG_ID, name: 'Blog Techniczny (Demo)', ga4_property_id: 'properties/219873305',
    status: 'active', alert_threshold: 70, alert_email: 'demo@example.com', auto_run: true,
    last_score: 74, prev_week_score: 82,
    ecommerce_events_count: 0, custom_events_count: 3, parameter_checks_count: 3,
  },
]
